...
export const sectionBgLogin = `${sectionBgBase} from-blue-400 via-orange-500 to-red-500`
export const sectionBgLoginDark = `${sectionBgBase} from-blue-900 via-orange-900 to-red-900`
